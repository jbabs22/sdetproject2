...
// Describe = Test Suite
test.describe("UI Playwright Tests", () => {
  // Test = Test Case
  test("Login Validation - login successfully", async ({ page }) => {
    const loginPage = new LoginPage(page);
  ...
  test("Positive Test - Add New Contact to List", async ({ page }) => {
    const loginPage = new LoginPage(page);
  ...
  test("Negative Test - invalid login error", async ({ page }) => {
    const loginPage = new LoginPage(page);
